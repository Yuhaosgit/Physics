...
NavigationGrid::NavigationGrid(const std::string&filename) : NavigationGrid() {
	...
	node_number = gridWidth * gridHeight;
...
bool NavigationGrid::FindPath(const Vector3& from, const Vector3& to, NavigationPath& outPath) {
	...
	Debug::DrawLine((Vector3(fromX, 0, fromZ) * nodeSize), (Vector3(fromX, 10, fromZ) * nodeSize), Vector4(1,0,1,1));
	Debug::DrawLine((Vector3(toX, 0, toZ) * nodeSize), (Vector3(toX, 10, toZ) * nodeSize), Vector4(1, 0, 1, 1));
